        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalSpend = table.Column<decimal>(type: "decimal(18,4)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StockMovementsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockMovements", x => x.StockMovementsId);
                    table.ForeignKey(
                        name: "FK_StockMovements_OrderTypes_OrderTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_OrderTypeId",
